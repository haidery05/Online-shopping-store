            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                       ...
                       <a class="btn btn-primary" href="{{url('/subcats')}}">Sub Categories</a>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <img src="public/images/{{ Auth::user()->picture }}" style="height: 32px; width: 32px; position: absolute; left: 10px; border-radius: 50%;" >
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                       ...
                                       >
                                        <i class="fa fa-btn fa-btn-user"></i>Profile Dashboard 
                                    </a>
